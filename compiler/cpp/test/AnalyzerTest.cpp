...
const AnalyzerParams ANALYZER_TEST_PARAMETERS[] = {
    {"conditional-section-valid", false, ""},
    {"conditional-section-error-int-string", // Expects int, but data has string
     false, "Incompatible data types: '\"Test string\"' is not an integer"},
    {"conditional-section-error-int-boolean", // Expects int, but data has boolean
     false, "Incompatible data types: 'false' is not an integer"},
    {"conditional-section-error-boolean-int", // Expects boolean, but data has int
     false, "Incompatible data types: '4321' is not a boolean"},
    {"conditional-section-error-boolean-string", // Expects boolean, but data has string
     false, "Incompatible data types: '\"Test string\"' is not a boolean"},
    {"conditional-section-error-string-int", // Expects string, but data has int
     false, "Incompatible data types: '1234' is not a string"},
    {"conditional-section-error-string-boolean", // Expects string, but data has boolean
     false, "Incompatible data types: 'true' is not a string"},
    {"single-statement-valid", true, ""},
    {"conditional-section-error-int-string", // Expects int, but data has string
     true, "Incompatible data types: '\"Test string\"' is not an integer"},
    {"conditional-section-error-int-boolean", // Expects int, but data has boolean
     true, "Incompatible data types: 'false' is not an integer"},
    {"conditional-section-error-boolean-int", // Expects boolean, but data has int
     true, "Incompatible data types: '4321' is not a boolean"},
    {"conditional-section-error-boolean-string", // Expects boolean, but data has string
     true, "Incompatible data types: '\"Test string\"' is not a boolean"},
    {"conditional-section-error-string-int", // Expects string, but data has int
     true, "Incompatible data types: '1234' is not a string"},
    {"conditional-section-error-string-boolean", // Expects string, but data has boolean
     true, "Incompatible data types: 'true' is not a string"}};
...
INSTANTIATE_TEST_SUITE_P(AnalyzerTests, AnalyzerTests, ::testing::ValuesIn(ANALYZER_TEST_PARAMETERS));