...
const std::vector<LanguageDescriptor> LANGUAGES{
    LanguageDescriptor("cpp", "//", "/*", "*/"), LanguageDescriptor("html", "", "<!--", "-->"),
    LanguageDescriptor("py", "#", R"(""")", R"(""")"), LanguageDescriptor("yml", "#", "", "")};

const LexerParams LEXER_TEST_PARAMETERS[] = {
    {"brace-close",
     {{"cpp", {Token(TokenType::TOK_COM_LINE_IDEN, 1, 1), Token(TokenType::TOK_BRACE_CLOSE, 1, 5)}},
      {"html", {Token(TokenType::TOK_COM_BLOCK_IDEN_OPEN, 1, 1), Token(TokenType::TOK_BRACE_CLOSE, 1, 7)}},
      {"py", {Token(TokenType::TOK_COM_LINE_IDEN, 1, 1), Token(TokenType::TOK_BRACE_CLOSE, 1, 4)}},
      {"yml", {Token(TokenType::TOK_COM_LINE_IDEN, 1, 1), Token(TokenType::TOK_BRACE_CLOSE, 1, 4)}}}},
    {"brace-open",
     {{"cpp", {Token(TokenType::TOK_COM_LINE_IDEN, 1, 1), Token(TokenType::TOK_BRACE_OPEN, 1, 5)}},
      {"html", {Token(TokenType::TOK_COM_BLOCK_IDEN_OPEN, 1, 1), Token(TokenType::TOK_BRACE_OPEN, 1, 7)}},
      {"py", {Token(TokenType::TOK_COM_LINE_IDEN, 1, 1), Token(TokenType::TOK_BRACE_OPEN, 1, 4)}},
      {"yml", {Token(TokenType::TOK_COM_LINE_IDEN, 1, 1), Token(TokenType::TOK_BRACE_OPEN, 1, 4)}}}},
    {"dot",
     {{"cpp", {Token(TokenType::TOK_COM_LINE_IDEN, 1, 1), Token(TokenType::TOK_DOT, 1, 5)}},
      {"html", {Token(TokenType::TOK_COM_BLOCK_IDEN_OPEN, 1, 1), Token(TokenType::TOK_DOT, 1, 7)}},
      {"py", {Token(TokenType::TOK_COM_LINE_IDEN, 1, 1), Token(TokenType::TOK_DOT, 1, 4)}},
      {"yml", {Token(TokenType::TOK_COM_LINE_IDEN, 1, 1), Token(TokenType::TOK_DOT, 1, 4)}}}},
    {"equals",
     {{"cpp", {Token(TokenType::TOK_COM_LINE_IDEN, 1, 1), Token(TokenType::TOK_EQUALS, 1, 5)}},
      {"html", {Token(TokenType::TOK_COM_BLOCK_IDEN_OPEN, 1, 1), Token(TokenType::TOK_EQUALS, 1, 7)}},
      {"py", {Token(TokenType::TOK_COM_LINE_IDEN, 1, 1), Token(TokenType::TOK_EQUALS, 1, 4)}},
      {"yml", {Token(TokenType::TOK_COM_LINE_IDEN, 1, 1), Token(TokenType::TOK_EQUALS, 1, 4)}}}},
    {"false",
     {{"cpp", {Token(TokenType::TOK_COM_LINE_IDEN, 1, 1), Token(TokenType::TOK_FALSE, 1, 5)}},
      {"html", {Token(TokenType::TOK_COM_BLOCK_IDEN_OPEN, 1, 1), Token(TokenType::TOK_FALSE, 1, 7)}},
      {"py", {Token(TokenType::TOK_COM_LINE_IDEN, 1, 1), Token(TokenType::TOK_FALSE, 1, 4)}},
      {"yml", {Token(TokenType::TOK_COM_LINE_IDEN, 1, 1), Token(TokenType::TOK_FALSE, 1, 4)}}}},
    {"greater",
     {{"cpp", {Token(TokenType::TOK_COM_LINE_IDEN, 1, 1), Token(TokenType::TOK_GREATER, 1, 5)}},
      {"html", {Token(TokenType::TOK_COM_BLOCK_IDEN_OPEN, 1, 1), Token(TokenType::TOK_GREATER, 1, 7)}},
      {"py", {Token(TokenType::TOK_COM_LINE_IDEN, 1, 1), Token(TokenType::TOK_GREATER, 1, 4)}},
      {"yml", {Token(TokenType::TOK_COM_LINE_IDEN, 1, 1), Token(TokenType::TOK_GREATER, 1, 4)}}}},
    {"greater-equal",
     {{"cpp", {Token(TokenType::TOK_COM_LINE_IDEN, 1, 1), Token(TokenType::TOK_GREATER_EQUAL, 1, 5)}},
      {"html", {Token(TokenType::TOK_COM_BLOCK_IDEN_OPEN, 1, 1), Token(TokenType::TOK_GREATER_EQUAL, 1, 7)}},
      {"py", {Token(TokenType::TOK_COM_LINE_IDEN, 1, 1), Token(TokenType::TOK_GREATER_EQUAL, 1, 4)}},
      {"yml", {Token(TokenType::TOK_COM_LINE_IDEN, 1, 1), Token(TokenType::TOK_GREATER_EQUAL, 1, 4)}}}},
    {"has",
     {{"cpp", {Token(TokenType::TOK_COM_LINE_IDEN, 1, 1), Token(TokenType::TOK_HAS, 1, 5)}},
      {"html", {Token(TokenType::TOK_COM_BLOCK_IDEN_OPEN, 1, 1), Token(TokenType::TOK_HAS, 1, 7)}},
      {"py", {Token(TokenType::TOK_COM_LINE_IDEN, 1, 1), Token(TokenType::TOK_HAS, 1, 4)}},
      {"yml", {Token(TokenType::TOK_COM_LINE_IDEN, 1, 1), Token(TokenType::TOK_HAS, 1, 4)}}}},
    {"contains",
     {{"cpp", {Token(TokenType::TOK_COM_LINE_IDEN, 1, 1), Token(TokenType::TOK_CONTAINS, 1, 5)}},
      {"html", {Token(TokenType::TOK_COM_BLOCK_IDEN_OPEN, 1, 1), Token(TokenType::TOK_CONTAINS, 1, 7)}},
      {"py", {Token(TokenType::TOK_COM_LINE_IDEN, 1, 1), Token(TokenType::TOK_CONTAINS, 1, 4)}},
      {"yml", {Token(TokenType::TOK_COM_LINE_IDEN, 1, 1), Token(TokenType::TOK_CONTAINS, 1, 4)}}}},
    {"identifier",
     {{"cpp", {Token(TokenType::TOK_COM_LINE_IDEN, 1, 1), Token(TokenType::TOK_IDENTIFIER, "testIdentifier", 1, 5)}},
      {"html", {Token(TokenType::TOK_COM_BLOCK_IDEN_OPEN, 1, 1), Token(TokenType::TOK_IDENTIFIER, "testIdentifier", 1, 7)}},
      {"py", {Token(TokenType::TOK_COM_LINE_IDEN, 1, 1), Token(TokenType::TOK_IDENTIFIER, "testIdentifier", 1, 4)}},
      {"yml", {Token(TokenType::TOK_COM_LINE_IDEN, 1, 1), Token(TokenType::TOK_IDENTIFIER, "testIdentifier", 1, 4)}}}},
    {"if",
     {{"cpp", {Token(TokenType::TOK_COM_LINE_IDEN, 1, 1), Token(TokenType::TOK_IF, 1, 5)}},
      {"html", {Token(TokenType::TOK_COM_BLOCK_IDEN_OPEN, 1, 1), Token(TokenType::TOK_IF, 1, 7)}},
      {"py", {Token(TokenType::TOK_COM_LINE_IDEN, 1, 1), Token(TokenType::TOK_IF, 1, 4)}},
      {"yml", {Token(TokenType::TOK_COM_LINE_IDEN, 1, 1), Token(TokenType::TOK_IF, 1, 4)}}}},
    {"index",
     {{"cpp", {Token(TokenType::TOK_COM_LINE_IDEN, 1, 1), Token(TokenType::TOK_INDEX, "1234", 1, 5)}},
      {"html", {Token(TokenType::TOK_COM_BLOCK_IDEN_OPEN, 1, 1), Token(TokenType::TOK_INDEX, "1234", 1, 7)}},
      {"py", {Token(TokenType::TOK_COM_LINE_IDEN, 1, 1), Token(TokenType::TOK_INDEX, "1234", 1, 4)}},
      {"yml", {Token(TokenType::TOK_COM_LINE_IDEN, 1, 1), Token(TokenType::TOK_INDEX, "1234", 1, 4)}}}},
    {"less",
     {{"cpp", {Token(TokenType::TOK_COM_LINE_IDEN, 1, 1), Token(TokenType::TOK_LESS, 1, 5)}},
      {"html", {Token(TokenType::TOK_COM_BLOCK_IDEN_OPEN, 1, 1), Token(TokenType::TOK_LESS, 1, 7)}},
      {"py", {Token(TokenType::TOK_COM_LINE_IDEN, 1, 1), Token(TokenType::TOK_LESS, 1, 4)}},
      {"yml", {Token(TokenType::TOK_COM_LINE_IDEN, 1, 1), Token(TokenType::TOK_LESS, 1, 4)}}}},
    {"less-equal",
     {{"cpp", {Token(TokenType::TOK_COM_LINE_IDEN, 1, 1), Token(TokenType::TOK_LESS_EQUAL, 1, 5)}},
      {"html", {Token(TokenType::TOK_COM_BLOCK_IDEN_OPEN, 1, 1), Token(TokenType::TOK_LESS_EQUAL, 1, 7)}},
      {"py", {Token(TokenType::TOK_COM_LINE_IDEN, 1, 1), Token(TokenType::TOK_LESS_EQUAL, 1, 4)}},
      {"yml", {Token(TokenType::TOK_COM_LINE_IDEN, 1, 1), Token(TokenType::TOK_LESS_EQUAL, 1, 4)}}}},
    {"not",
     {{"cpp", {Token(TokenType::TOK_COM_LINE_IDEN, 1, 1), Token(TokenType::TOK_NOT, 1, 5)}},
      {"html", {Token(TokenType::TOK_COM_BLOCK_IDEN_OPEN, 1, 1), Token(TokenType::TOK_NOT, 1, 7)}},
      {"py", {Token(TokenType::TOK_COM_LINE_IDEN, 1, 1), Token(TokenType::TOK_NOT, 1, 4)}},
      {"yml", {Token(TokenType::TOK_COM_LINE_IDEN, 1, 1), Token(TokenType::TOK_NOT, 1, 4)}}}},
    {"not-equals",
     {{"cpp", {Token(TokenType::TOK_COM_LINE_IDEN, 1, 1), Token(TokenType::TOK_NOT_EQUALS, 1, 5)}},
      {"html", {Token(TokenType::TOK_COM_BLOCK_IDEN_OPEN, 1, 1), Token(TokenType::TOK_NOT_EQUALS, 1, 7)}},
      {"py", {Token(TokenType::TOK_COM_LINE_IDEN, 1, 1), Token(TokenType::TOK_NOT_EQUALS, 1, 4)}},
      {"yml", {Token(TokenType::TOK_COM_LINE_IDEN, 1, 1), Token(TokenType::TOK_NOT_EQUALS, 1, 4)}}}},
    {"number",
     {{"cpp", {Token(TokenType::TOK_COM_LINE_IDEN, 1, 1), Token(TokenType::TOK_NUMBER, "42", 1, 5)}},
      {"html", {Token(TokenType::TOK_COM_BLOCK_IDEN_OPEN, 1, 1), Token(TokenType::TOK_NUMBER, "42", 1, 7)}},
      {"py", {Token(TokenType::TOK_COM_LINE_IDEN, 1, 1), Token(TokenType::TOK_NUMBER, "42", 1, 4)}},
      {"yml", {Token(TokenType::TOK_COM_LINE_IDEN, 1, 1), Token(TokenType::TOK_NUMBER, "42", 1, 4)}}}},
    {"or",
     {{"cpp", {Token(TokenType::TOK_COM_LINE_IDEN, 1, 1), Token(TokenType::TOK_OR, 1, 5)}},
      {"html", {Token(TokenType::TOK_COM_BLOCK_IDEN_OPEN, 1, 1), Token(TokenType::TOK_OR, 1, 7)}},
      {"py", {Token(TokenType::TOK_COM_LINE_IDEN, 1, 1), Token(TokenType::TOK_OR, 1, 4)}},
      {"yml", {Token(TokenType::TOK_COM_LINE_IDEN, 1, 1), Token(TokenType::TOK_OR, 1, 4)}}}},
    {"string",
     {{"cpp", {Token(TokenType::TOK_COM_LINE_IDEN, 1, 1), Token(TokenType::TOK_STRING, "May the force be with you!", 1, 5)}},
      {"html",
       {Token(TokenType::TOK_COM_BLOCK_IDEN_OPEN, 1, 1), Token(TokenType::TOK_STRING, "May the force be with you!", 1, 7)}},
      {"py", {Token(TokenType::TOK_COM_LINE_IDEN, 1, 1), Token(TokenType::TOK_STRING, "May the force be with you!", 1, 4)}},
      {"yml", {Token(TokenType::TOK_COM_LINE_IDEN, 1, 1), Token(TokenType::TOK_STRING, "May the force be with you!", 1, 4)}}}},
    {"true",
     {{"cpp", {Token(TokenType::TOK_COM_LINE_IDEN, 1, 1), Token(TokenType::TOK_TRUE, 1, 5)}},
      {"html", {Token(TokenType::TOK_COM_BLOCK_IDEN_OPEN, 1, 1), Token(TokenType::TOK_TRUE, 1, 7)}},
      {"py", {Token(TokenType::TOK_COM_LINE_IDEN, 1, 1), Token(TokenType::TOK_TRUE, 1, 4)}},
      {"yml", {Token(TokenType::TOK_COM_LINE_IDEN, 1, 1), Token(TokenType::TOK_TRUE, 1, 4)}}}}};
...
void expectToken(Lexer &lexer, Token expectedToken) {
  ...
  if (actualToken.getType() != expectedToken.getType() || actualToken.getValue() != expectedToken.getValue() ||
    ...
    throw std::runtime_error("Expected and actual tokens do not match at " + actualToken.getCodePos() + ". Expected was " +
                             std::to_string(expectedToken.getType()) + ", actual was " + std::to_string(actualToken.getType()) +
                             ", actual value was: '" + actualToken.getValue() + "'");
  }
  lexer.advance();
}
...
INSTANTIATE_TEST_SUITE_P(LexerTests, LexerTests, ::testing::ValuesIn(LEXER_TEST_PARAMETERS));