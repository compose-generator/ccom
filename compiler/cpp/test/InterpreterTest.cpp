...
const InterpreterParams INTERPRETER_TEST_PARAMETERS[] = {{"case1", "yml", "#", "", "", false, ""},
                                                         {"case2", "cpp", "//", "/*", "*/", false, ""},
                                                         {"case3", "html", "", "<!--", "-->", false, ""},
                                                         {"case4", "html", "", "<!--", "-->", false, ""},
                                                         {"case5", "yml", "#", "", "", false, ""}};
...
INSTANTIATE_TEST_SUITE_P(InterpreterTests, InterpreterTests, ::testing::ValuesIn(INTERPRETER_TEST_PARAMETERS));